/**
  ******************************************************************************
  * @file    sine_modelm4_data_params.c
...
/**  Activations Section  ****************************************************/
ai_handle g_sine_modelm4_activations_table[1 + 2] = {
...
/**  Weights Section  ********************************************************/
AI_ALIGNED(32)
const ai_u64 s_sine_modelm4_weights_array_u64[161] = {
...
ai_handle g_sine_modelm4_weights_table[1 + 2] = {
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
  AI_HANDLE_PTR(s_sine_modelm4_weights_array_u64),
  AI_HANDLE_PTR(AI_MAGIC_MARKER),
};
