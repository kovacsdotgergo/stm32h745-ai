...
#include "models/sine_modelm4.h"
#include "models/sine_modelm4_data.h"
#include "tim.h"
...
void ai_model_init() {
  ...
  ai_input = AI_SINE_MODELM4_IN;
  ai_output = AI_SINE_MODELM4_OUT;
  ...
  ai_error ai_err =
      ai_sine_modelm4_create(&sine_model, AI_SINE_MODELM4_DATA_CONFIG);
...
void ai_model_run() {
  ...
  // Perform inference
  ai_i32 nbatch = ai_sine_modelm4_run(sine_model, &ai_input[0], &ai_output[0]);
