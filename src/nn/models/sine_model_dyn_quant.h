#ifndef SINE_MODEL_DYN_QUANT_H
#define SINE_MODEL_DYN_QUANT_H

unsigned char sine_model_dyn_quant_tflite[] = {
...
unsigned int sine_model_dyn_quant_tflite_len = 3168;

#endif // SINE_MODEL_DYN_QUANT_H
